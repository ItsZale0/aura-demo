...
async function repairJSON(brokenText, errors){
  ...
  var res = await fetch(WORKER_URL, {method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({model:'nex-agi/nex-n2.5-pro:free', messages:[{role:'user', content:repairPrompt}], max_tokens:2000})});
